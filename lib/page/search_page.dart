...
import 'package:imaplemobile/widgets/on_screen_keyboard.dart';
...
class SearchPageState extends State<SearchPage> {
  ...
  final TextEditingController _searchTextController = TextEditingController(text: '');
  ...
  void initState() {
    ...
    _searchTextController.addListener(() {
      EasyDebounce.debounce('search_search', const Duration(milliseconds: 500), () {
        _changeSearchText(_searchTextController.text);
      });
    });
    super.initState();
  }
                        ...
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              onChanged: (String text) => EasyDebounce.debounce(
                                  'search_search', const Duration(milliseconds: 500), () {
                                _changeSearchText(text);
                              }),
                              decoration: InputDecoration(
                                  border: UnderlineInputBorder(borderSide: BorderSide(color: Colors.grey)),
                                  hintText: '搜索电影...   (支持拼音/简体输入法)'),
                            ),
                          ),
                        ),
                        Expanded(
